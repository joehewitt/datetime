var locales = {
    ...
    'de-DE': {
        ...
        dayNamesAbbreviated: ["So", "Mo", "Di", "Mi", "Do", "Fr", "Sa"],
        monthNames: ["Januar", "Februar", "März", "April", "Mai", "Juni", "Juli", "August",
                     "September", "Oktober", "November", "Dezember"],
        monthNamesAbbreviated: ["Jan", "Feb", "Mär", "Apr", "Mai", "Jun", "Jul",
                                "Aug", "Sep", "Okt", "Nov", "Dez"],
        ...
        secondsAgo: 'vor %t Sekunden',
        minuteAgo: 'vor einer Minute',
        minutesAgo: 'vor %t Minuten',
        hourAgo: 'vor einer Stunde',
        hoursAgo: 'vor %t Stunden',
        dayAgo: 'vor einem Tag',
        daysAgo: 'vor %t Tagen',

        secondIn: 'in einer Sekunde',
        secondsIn: 'in %t Sekunden',
        minuteIn: 'in einer Minute',
        minutesIn: 'in %t Minuten',
        hourIn: 'in einer Stunde',
        hoursIn: 'in %t Stunden',
        dayIn: 'in einem Tag',
        daysIn: 'in %t Tagen',
    }
};
